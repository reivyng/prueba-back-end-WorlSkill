...
public class ClienteController : GenericController<ClienteDto, Cliente>, IClienteController
{
    ...
    [HttpPatch("update")]
    public async Task<IActionResult> UpdatePartial(int id, [FromBody] ClienteUpdateDto dto)
    {
    ...
    public async Task<IActionResult> DeleteLogic(int id)
    {
        try
        {
            var dto = new ClienteActiveDto { Id = id, Active = false };

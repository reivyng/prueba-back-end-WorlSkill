...
public class PizzaController : GenericController<PizzaDto, Pizza>, IPizzaController
{
    ...
    protected override int GetEntityId(PizzaDto dto)
    {
        return dto.Id;
    }
    ...
    [HttpPatch("update")]
    public async Task<IActionResult> UpdatePartial(int id, [FromBody] PizzaUpdateDto dto)
    {

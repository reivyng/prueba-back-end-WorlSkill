...
public class PedidoController : GenericController<PedidoDto, Pedido>, IPedidoController
{
    ...
    protected override int GetEntityId(PedidoDto dto)
    {
        return dto.Id;
    }

    [HttpPatch("update")]
    public async Task<IActionResult> UpdatePartial(int id, [FromBody]  PedidoDto dto)
    {
